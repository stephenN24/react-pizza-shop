...
function CreateOrder() {
  ...
  const priorityPricel = withPriority ? totalCartPrice * 0.2 : 0;
  const totalPrice = totalCartPrice + priorityPricel;
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone))
    errors.phone = 'Please give us your correct phone numbder.';
